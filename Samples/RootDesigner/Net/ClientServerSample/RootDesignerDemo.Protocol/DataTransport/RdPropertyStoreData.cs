...
namespace RootDesignerDemo.Protocol.DataTransport
{
    /// <summary>
    ///  Transport class to carry the content of the RdPropertyStore 
    ///  from the DesignToolServer's server process to the client (Visual Studio)
    ///  and back.
    /// </summary>
    [DebuggerDisplay("{" + nameof(GetDebuggerDisplay) + "(),nq}")]
    public partial class RdPropertyStoreData : IDataPipeObject
    {
        [AllowNull]
